...
interface PhoneInterface { 								// 인터페이스 작성
	int BUTTONS = 20; 									// 상수 필드 선언. public static final int BUTTONS = 20;과 동일.
	void sendCall();
	void receiveCall();
}
...
// MobilePhoneInterface와 MP3Interface ㅣㅇㄴ터페이스에 선언된 메소드를 모두 구현한다.

class SmartPhone extends PDA implements MobilePhoneInterface, MP3Interface {
	public void sendCall() { System.out.println("전화 걸기"); }
	public void receiveCall() { System.out.println("전하 받기"); }
